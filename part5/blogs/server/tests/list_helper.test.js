...
describe('total likes', () => {
  ...
  test('when list has only one blog equals the the likes of that', () => {
...
describe('favorite blog', () => {
  ...
  test('when list has only one blog equals to that blog', () => {
    expect(listHelper.favoriteBlog(listWithOneBlog)).toEqual(listWithOneBlogFav)
  })
...
describe('most blog', () => {
  ...
  test('when list has only one blog equals to that blog', () => {
    expect(listHelper.mostBlogs(listWithOneBlog)).toEqual(expectResultOfOneBlog)
  })
...
describe('most likes', () => {
  ...
  test('when list has only one blog equals to that blog', () => {
    expect(listHelper.mostLikes(listWithOneBlog)).toEqual(expectResultOfOneBlog)
  })
